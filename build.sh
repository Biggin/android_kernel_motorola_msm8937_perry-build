if [ -z $2 ] || [ -z $3 ]
then
 printf "\nUsage: \n\n\tbash build.sh [thread_amount] 
device_codename maintainer_username\n\n\tNOTE: 
...
# if [ $? -ne 0 ]
# then
#  echo "Unable to prepare the toolchain, please check the 
# errors above."
#  exit 1
# fi
# cd $KERNEL_DIR
...
cp "$Anykernel_DIR/modules/system/lib/modules/wlan.ko" 
"$Anykernel_DIR/modules/system/lib/modules/pronto/pronto_wlan.ko"
